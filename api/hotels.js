...
// 47都道府県の県庁所在地キーワードマップ
const STATION_MAP = {
  '北海道':'札幌市中央区','青森県':'青森市長島','岩手県':'盛岡市内丸','宮城県':'仙台市青葉区',
  '秋田県':'秋田市山王','山形県':'山形市松波','福島県':'福島市杉妻町','茨城県':'水戸市笠原町',
  '栃木県':'宇都宮市塙田','群馬県':'前橋市大手町','埼玉県':'さいたま市浦和区','千葉県':'千葉市中央区',
  '東京都':'新宿区西新宿','神奈川県':'横浜市中区','新潟県':'新潟市中央区','富山県':'富山市新総曲輪',
  '石川県':'金沢市鞍月','福井県':'福井市大手','山梨県':'甲府市丸の内','長野県':'長野市大字南長野',
  '岐阜県':'岐阜市藪田南','静岡県':'静岡市葵区','愛知県':'名古屋市中区','三重県':'津市広明町',
  '滋賀県':'大津市京町','京都府':'京都市上京区','大阪府':'大阪市中央区','兵庫県':'神戸市中央区',
  '奈良県':'奈良市登大路町','和歌山県':'和歌山市小松原通','鳥取県':'鳥取市東町','島根県':'松江市殿町',
  '岡山県':'岡山市北区内山下','広島県':'広島市中区基町','山口県':'山口市滝町','徳島県':'徳島市万代町',
  '香川県':'高松市番町','愛媛県':'松山市一番町','高知県':'高知市丸ノ内','福岡県':'福岡市博多区',
  '佐賀県':'佐賀市城内','長崎県':'長崎市江戸町','熊本県':'熊本市中央区','大分県':'大分市大手町',
  '宮崎県':'宮崎市橘通東','鹿児島県':'鹿児島市鴨池新町','沖縄県':'那覇市泉崎',
};
